        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmailConfirmacionToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmailConfirmacionExpira = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EmailConfirmado = table.Column<bool>(type: "bit", nullable: false),
                    FechaEmailConfirmado = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CodigoVerificacionExpira = table.Column<DateTime>(type: "datetime2", nullable: true),
